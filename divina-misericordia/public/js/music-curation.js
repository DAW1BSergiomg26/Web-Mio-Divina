...
const sectionMusicMapping = {
  ...
  // ==================== DEVOCIONES DIVINA MISERICORDIA ====================
  ...
  'musica-sacra': {
    ...
    title: 'Música Sacra',
    pistaPrincipal: 'all', // Todas las pistas disponibles
...
// Generar reporte
console.log('═══════════════════════════════════════════════════════════');
console.log('REPORTE DE CURADURÍA MUSICAL');
console.log('═══════════════════════════════════════════════════════════');
console.log('Total de secciones mapeadas:', Object.keys(sectionMusicMapping).length);
console.log('═══════════════════════════════════════════════════════════');